...
Posted on
2008-06-24 14:30
\[<a href="index.html" target="_self" title="Permalink to Allow the Upload of Large Files with ASP.NET">Permalink</a>\]

I found <a href="http://www.codeproject.com/KB/aspnet/uploadlargefilesaspnet.aspx" target="_blank" title="Setting up Web.config to allow uploading of large files by ASP.net">this post</a> while googling a bit... and I'm reporting the just the essentials, for further reference.
