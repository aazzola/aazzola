...
The script allows you to turn a *text string* into a proper <a href="http://en.wikipedia.org/wiki/Slug_%28web_publishing%29" target="_blank" title="Definition of URL slug">URL slug</a>. It's a mix of both <a href="http://jquery.com" target="_blank">jQuery</a> and standard <a href="http://andreaazzola.com/category/javascript" target="_blank" title="JavaScript posts">JavaScript</a>, thought it can be easily turned into pure JS.  
...
<a href="http://facebook.com/sharer.php?u=http%3a%2f%2fandreaazzola.com%2ftransform-sentence-slug-js%2f" target="_blank" title="Share it on Facebook">Facebook</a>
