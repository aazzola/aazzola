...
Nei tempi moderni non è un mistero che le più grandi aziende al mondo scommettano sulla presenza web. Mentre la stabilità dei contratti di lavoro è continuamente messa a repentaglio dalla competizione globale, dall'outsourcing e dall'automazione, l'informazione la fa da cittadino di prima classe. Gli head hunters… ed i datori di lavoro in generale, trovano spesso tutte le crendenziali di cui hanno bisogno con semplici ricerche internet o raccomandazioni. La velocità di questo cambiamento potrebbe pur sembrare modesta, ma non conosce arresti.

## Un brand chiamato "tu"

Un brand è *un'identità composta da singolarità di valori*. Applicando questo concetto alla persone si evince il principio cardine: la distinzione. E naturalmente cerchiamo un tipo di distinzione positiva.
...
Possiamo decidere di usare questa percezione, o possiamo ignorarla. Non tutti si trovano a proprio agio a "promuoversi" ma è anche vero che nessuno vuole trovarsi come ultima ruota del carro, infatti è a ciò che può portare un'eccessiva trascuratezza.

## È guadagno passivo

> Don't try to do everything yourself. Find a horse to ride ~Jack Trout

La pubblicità è certamente l'anima del commercio. Ma può essere costosa, invasiva, sopraffacente. Molti persone stanno sviluppando gli anticorpi alle pubblicità.

Potresti aver sentito la frase "SEO is dead" e sebbene ciò non sia propriamente vero, ad esempio dalla versione Hummingird dell'algoritmo di ricerca, Google tende a curarsi meno delle parole chiave e molto più della circostante "<a href="https://www.youtube.com/watch?v=xQmQeKU25zg&amp;list=TLe6b5U3IbZbxyiAAWxi52RUtRXUBaxm-S#t=280" target="_blank">rete di fiducia</a>". L'obiettivo di Google dopotutto è di fornire agli utenti risposte efficaci.

Proiettando questo trend nel tempo, potremo intuire che *saranno sempre più i contenuti e la "social proof" (prova sociale) a farla da padroni*. Certamente il vecchio approccio di bussare alle porte della gente e sperare ci aprano ogni tanto funziona, tuttavia l'approccio del branding è diverso e tutto sommato più elegante. Il branding suggerisce che siano i clienti a venire da noi, per la **rete di fiducia** ed il **vero valore** che avremo costruito nel tempo. **L'obiettivo è che sia il brand a fare il lavoro promozionale per noi**.
...
- Massimizzare ricavi di un'attività esistente
- Gestire la reputazione on-line
- Accedere ai consigli di esperti
- Accrescere il proprio capitale sociale

## E se già lavoro per un azienda?

Molti si chiedono se sviluppare il proprio brand personale possa risultare concorrenziale per la propria azienda, di seguito spiegherò perchè non lo è:

1.  *Le aziende sono fatte di persone*, più alto il capitale sociale di un'azienda, migliori per essa le possibilità di accedere a opportunità importanti;
2.  Essere capaci di lavorare in qualità, e non saperlo comunicare, è un'opportunità sprecata per il lavoratore che non vede benefici e per l'azienda che non attinge a questo potenziale;
3.  *Rafforza la coesione nel team di lavoro,* in quanto ispira le persone a migliorarsi, offre supporto e canali non convenzioni, incrementa la visibilità del lavoro svolto da tutti.
